...
.factory('graph', [
    ...
    projectService.ready(function(project) {
        ...
        all_styles = all_styles.concat(style_ends)

        // console.log("all_styles", all_styles)
        // console.log("service", service)
        service.graph_element.setStyle(all_styles);
